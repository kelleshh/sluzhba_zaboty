...
- После нажатия любой кнопки бот:
  - отправляет пользователю новые сообщения,
  - удаляет старое сообщение с этой кнопкой.

  Это сделано, чтобы пользователь не мог повторно жать старые кнопки и ломать состояние.
